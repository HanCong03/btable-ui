...
'<li unselectable="on" ng-repeat="format in numberformatValues[3]" ng-class="{\'b-nubmerformat-preview-active\': status.dateSelected === $index}" ng-click="status.dateSelected=$index;">{{format.text}}</li>\n' +
'</ul>\n' +
'</label>\n' +
