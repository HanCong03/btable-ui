...
'<li unselectable="on" ng-repeat="format in status.format.time" ng-class="{\'b-nubmerformat-preview-active\': status._default.code.time === $index}" ng-click="status._default.code.time=$index;">{{format.text}}</li>\n' +
'</ul>\n' +
'</label>\n' +
