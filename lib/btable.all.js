...
_p[53] = {
    value: function(require) {
        var basic = _p.r(52);
        var DataHelper = _p.r(54);
        // TODO 解决引用问题
        var KernelHelper = _p.r(112);
        var CONFIG = _p.r(33);
...
_p[64] = {
    value: function(require) {
        var DEFAULT_FORMAT = _p.r(63);
        var TYPE_STYLE = _p.r(65);
...
_p[66] = {
    value: function(require) {
        var CELL_VALUE_TYPE = _p.r(80);
        var NUMBERS_FORMAT = _p.r(81);
        var BOOLEAN_VALUE = _p.r(79);
        var NumericAnalyzer = _p.r(68);
        var DateTimeAnalyzer = _p.r(67);
        return {
            /**
...
_p[71] = {
    value: function(require) {
        var FormatAnalyzer = _p.r(66);
        var DateTimeConverter = _p.r(70);
        var NumericFormat = _p.r(72);
...
_p[85] = {
    value: function(require) {
        var Container = _p.r(88);
        var ElementFactory = _p.r(89);
        var Service = _p.r(92);
        var Command = _p.r(87);
        var Message = _p.r(90);
        var RefreshManager = _p.r(91);
        var Configure = _p.r(84);
        var ModuleLoader = _p.r(93);
        var PluginWrapper = _p.r(94);
    ...
    value: function(require) {
        ...
        function importValue(data) {
            ...
            for (var i = 0, len = valueData.length; i < len; i++) {
                ...
                result[HASH.indexToKey(currentData.r, currentData.c)] = (currentData.v + "").trimRight();
            }
            return result;
        }
...
_p[122] = {
    value: function(require) {
        var StyleCommand = _p.r(119);
        var ResizeCommand = _p.r(118);
        var ClearCommand = _p.r(115);
        var WriteCommand = _p.r(120);
        var ExportCommand = _p.r(116);
        var PasteCommand = _p.r(117);
        return {
            write: WriteCommand,
...
_p[123] = {
    value: function(require) {
        var MIN_SIZE = 5;
        var ESCAPE_MAP = _p.r(110);
        var UNESCAPE_MAP = _p.r(134);
        var HASH = _p.r(111);
        var KernelHelper = _p.r(112);
        return $.extend({
            /* ---------------- read ---------------- */
        ...
        }, _p.r(111), _p.r(127), _p.r(129), _p.r(130), _p.r(124), _p.r(125), _p.r(132), _p.r(126), _p.r(128));
    }
};
...
_p[125] = {
    value: function(require) {
        var HASH = _p.r(111);
        var NONE = "none";
        var LOCAL_BORDER_CONFIG = _p.r(32).border;
        var BORDER_TYPE = _p.r(108);
        return {
...
_p[140] = {
    value: function(require) {
        var StandardStyle = _p.r(142);
        var INLINE_ELEMENTS = _p.r(141);
        var ELEMENT_BLACKLIST = _p.r(136);
        var DEFAULT_ELEMENT_STYLE = _p.r(138);
...
_p[154] = {
    value: function(require) {
        var $ = _p.r(2);
        var KEY_CODE = _p.r(149);
        var InputShadowMan = _p.r(153);
        var TextHelper = _p.r(155);
...
_p[159] = {
    value: function(require) {
        var Canvas = _p.r(169);
        var CellGrid = _p.r(160);
        var Painter = _p.r(165);
...
_p[165] = {
    value: function(require) {
        ...
        var Canvas = _p.r(169);
        var ContentFillPainter = _p.r(167);
        var ContentPainter = _p.r(168);
        var CellFillPainter = _p.r(166);
        var GridPainter = _p.r(163);
        var BorderPainter = _p.r(161);
        var BoxPainter = _p.r(162);
        var MergeFillPainter = _p.r(164);
...
_p[171] = {
    value: function(require) {
        var BodyScreen = _p.r(159);
        var TopScreen = _p.r(172);
        var LeftScreen = _p.r(170);
...
_p[174] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(173);
...
_p[179] = {
    value: function(require) {
        ...
        BTable.module(_p.r(135));
        BTable.mapEvent(_p.r(95));
        BTable.Interpreter = _p.r(121);
        BTable.ExcelAdapter = _p.r(104);
