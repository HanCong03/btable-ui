...
_p[100] = {
    value: function(require) {
        var StyleCommand = _p.r(97);
        var ResizeCommand = _p.r(96);
        var ClearCommand = _p.r(94);
        var WriteCommand = _p.r(98);
        var ExportCommand = _p.r(95);
        return {
            write: WriteCommand,
...
_p[109] = {
    value: function(require) {
        var StandardStyle = _p.r(111);
        var INLINE_ELEMENTS = _p.r(110);
        var ELEMENT_BLACKLIST = _p.r(105);
        var DEFAULT_ELEMENT_STYLE = _p.r(107);
        ...
        return _p.r(0).create("PasteHtmlFilter", {
            ...
            __getStyle: function(node) {
                ...
                if (color === BACKGROUND_COLOR && !backgroundColor) {
                    while (!backgroundColor || backgroundColor === "inherit") {
                        node = node.parentNode;
                        if (node) {
...
_p[122] = {
    value: function(require) {
        var $ = _p.r(2);
        var KEY_CODE = _p.r(117);
        var InputShadowMan = _p.r(121);
        var TextHelper = _p.r(123);
        var BORDER_WIDTH = 2;
        var PADDING = 2;
...
_p[131] = {
    value: function(require) {
        ...
        var ContentLayoutAnalyzer = _p.r(130);
        var ContentFillPainter = _p.r(129);
        var CellFillPainter = _p.r(128);
        var ContentPainter = _p.r(132);
...
_p[137] = {
    value: function(require) {
        var BodyScreen = _p.r(127);
        var TopScreen = _p.r(138);
        var LeftScreen = _p.r(136);
        var GridScreen = _p.r(135);
...
_p[140] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(139);
...
_p[144] = {
    value: function(require) {
        ...
        BTalbe.module(_p.r(104));
        BTalbe.mapEvent(_p.r(82));
        BTalbe.Interpreter = _p.r(99);
