    ...
    value: function(require) {
        ...
        return _p.r(0).create("BodyScreen", {
            ...
            init: function() {
                ...
                this.contentShadowCanvas = new Canvas(this.getDocument(), 1, 1);
            ...
            resize: function(width, height) {
                ...
                this.contentShadowCanvas.resize(1, 1, this.getConfig("ZOOM"));
            },
            clear: function() {
                this.canvas.clear();
                this.visiableCanvas.clear();
                this.contentCanvas.clear();
                this.contentShadowCanvas.clear();
            },
            render: function() {
                var struct = this.rs("c.struct");
                var cellGrid = CellGrid.generate(struct);
                this.painter.draw(this.canvas, this.contentCanvas, this.contentShadowCanvas, struct, cellGrid);
                this.__toggle();
            },
            __toggle: function() {
...
_p[161] = {
    value: function(require) {
        ...
        return _p.r(0).create("Painter", {
            ...
            draw: function(canvas, contentCanvas, contentShadowCanvas, struct, cellGrid) {
                var rowLayout;
                ...
                var contentLayout = ContentPainter.draw(contentCanvas, contentShadowCanvas, layout);
...
_p[165] = {
    value: function(require) {
            ...
            draw: function(canvas, shadowCanvas, layout) {
                ...
                for (var i = 0, len = layout.length; i < len; i++) {
                    ...
                    for (var j = 0, jlen = rowLayout.length; j < jlen; j++) {
                        ...
                        resetStyle(shadowCanvas, currentLayout);
                        // mergecell 不用参与contentLayout的构建过程
                        if (currentLayout.type === "mergecell") {
                            currentContentLayout.push(drawMergeCellContent(shadowCanvas, currentLayout));
                        } else {
                            currentContentLayout.push(drawCellContent(shadowCanvas, currentLayout));
                        }
                        canvas.drawImage(shadowCanvas.getImage(), box.x, box.y);
                    }
        ...
        function drawCellContent(canvas, cellLayout) {
            ...
            return {
                x: getContentLeftOffset(displayContentWidth, box.x + startPoint, cellLayout.style.textAlign),
                y: box.y,
