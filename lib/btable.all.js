         ...
         */
            kernelExport: function() {
                ...
                return JSON.stringify({
                    ...
                    cellStyleXfs: data.cellStyleXfs,
                    merge: data.merge,
                    pane: data.pane,
...
_p[153] = {
    value: function(require) {
        var EventManager = _p.r(152);
        var InputWorker = _p.r(158);
        ...
        var Util = {
            getMergeCellVisibleRect: function(struct, mergeInfo) {
                ...
                if (pane.row === -1 && pane.col === -1) {
                    ...
                    return getRectInPane(struct, mergeInfo);
                }
            },
        ...
        return _p.r(0).create("InputWorker", $.extend({
            ...
            resetMergeCellInput: function(mergeInfo) {
                ...
                this.$wrapNode.css({
                    ...
                    width: rect.width,
                    height: rect.height,
                    borderTopStyle: rect.borderTop,
                    borderLeftStyle: rect.borderLeft,
                    borderRightStyle: rect.borderRight,
                    borderBottomStyle: rect.borderBottom
                });
                this.rect = rect;
            },
...
_p[164] = {
    value: function(require) {
        var Canvas = _p.r(184);
        var CellGrid = _p.r(165);
        var Painter = _p.r(169);
        return _p.r(0).create("BodyScreen", {
            panel: null,
            width: 0,
            height: 0,
...
_p[169] = {
    value: function(require) {
        var ContentFillPainter = _p.r(171);
        var ContentPainter = _p.r(172);
        var MergeFillPainter = _p.r(173);
        var CellFillPainter = _p.r(170);
        var GridPainter = _p.r(168);
        var BorderPainter = _p.r(166);
        var BoxPainter = _p.r(167);
        var PaneLinePainter = _p.r(163);
        return {
            draw: function(canvas, contentCanvas, struct) {
...
_p[174] = {
    value: function(require) {
        var NormalPainter = _p.r(169);
        var PanePainter = _p.r(179);
...
_p[179] = {
    value: function(require) {
        var ContentFillPainter = _p.r(181);
        var ContentPainter = _p.r(182);
        var MergeFillPainter = _p.r(183);
        var CellFillPainter = _p.r(180);
        var GridPainter = _p.r(178);
        var BorderPainter = _p.r(176);
        var BoxPainter = _p.r(177);
        var PaneLinePainter = _p.r(163);
        return {
            draw: function(canvas, contentCanvas, struct) {
...
_p[186] = {
    value: function(require) {
        var BodyScreen = _p.r(162);
        var TopScreen = _p.r(187);
        var LeftScreen = _p.r(185);
...
_p[190] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(189);
            ...
            onmouseleave: function(direction, r, c) {
                ...
                switch (direction) {
                  case "right":
                    ...
                    row = struct.getGrid().rowMap[r];
                    col = viewEnd.col;
                    //this.onmousemove(struct.getGrid().rowMap[r], viewEnd.col);
                    break;
                  ...
                  case "bottom":
                    ...
                    row = viewEnd.row;
                    col = struct.getGrid().colMap[c];
                    //this.onmousemove(viewEnd.row, struct.getGrid().colMap[c]);
                    break;
                  ...
                  case "top":
                    ...
                    row = viewStart.row;
                    col = struct.getGrid().colMap[c];
                    //this.onmousemove(viewStart.row, struct.getGrid().colMap[c]);
                    break;
                  ...
                  case "left":
                    ...
                    row = struct.getGrid().rowMap[r];
                    col = viewStart.col;
                    //this.onmousemove(struct.getGrid().rowMap[r], viewStart.col);
                    break;
                  ...
                  case "right-bottom":
                    ...
                    row = viewEnd.row;
                    col = viewEnd.col;
                    //this.onmousemove(viewEnd.row, viewEnd.col);
                    break;
                  ...
                  case "right-top":
                    ...
                    row = viewStart.row;
                    col = viewEnd.col;
                    //this.onmousemove(viewStart.row, viewEnd.col);
                    break;
                  ...
                  case "left-bottom":
                    ...
                    row = viewEnd.row;
                    col = viewStart.col;
                    //this.onmousemove(viewEnd.row, viewStart.col);
                    break;
                  ...
                  case "left-top":
                    ...
                    row = viewStart.row;
                    col = viewStart.col;
                    //this.onmousemove(viewStart.row, viewStart.col);
                    break;
                }
                this.__leaveProcess(row, col);
            },
            __leaveProcess: function(row, col) {
                this.selection.unstable();
                var activeCell = this.activeCell;
                var struct = this.rs("c.struct");
                var viewStart = struct.getViewStart();
...
_p[194] = {
    value: function(require) {
        var $ = _p.r(2);
        var Util = _p.r(156);
        var NormalWorker = _p.r(192);
        var PaneWorker = _p.r(193);
