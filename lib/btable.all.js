...
_p[4] = {
    value: function(require, exports, module) {
        var Context = _p.r(100);
        var FORMAT_CODE = _p.r(93);
        var codes = {};
...
_p[45] = {
    value: function(require) {
        var ERROR_VALUE = _p.r(92);
        var CELL_TYPE = _p.r(91);
        var TOKEN = _p.r(40);
        var TOKEN_SUBTYPE = TOKEN.SUBTYPE;
        var ComparisonRuntime = _p.r(46);
        var TypeCast = _p.r(50);
        return {
...
_p[49] = {
    value: function(require) {
        var TOKEN = _p.r(40);
        var TOKEN_TYPE = TOKEN.TYPE;
        var FunctionRuntime = _p.r(47);
        var BasicRuntime = _p.r(45);
        var ResultAnalyzer = _p.r(48);
...
_p[53] = {
    value: function(require) {
        var TokenAnalyzer = _p.r(55);
        var CellsParser = _p.r(52);
        var RPNParser = _p.r(54);
        var CellReferenceParser = _p.r(51);
        return {
            parse: function(text) {
...
_p[66] = {
    value: function(require) {
        var CELL_TYPE = _p.r(91);
        var NumberFormatter = _p.r(81);
        var LOGICAL_VALUE = _p.r(94);
        var CodeParser = _p.r(65);
...
_p[68] = {
    value: function(require) {
        var CELL_TYPE = _p.r(91);
        var NumberAnalyzer = _p.r(71);
        var LogicalAnalyzer = _p.r(70);
        var ErrorAnalyzer = _p.r(69);
        return {
            exec: function(content, numberFormatCode) {
                var result;
                if (!content) {
...
_p[71] = {
    value: function(require) {
        var NumericAnalyzer = _p.r(75);
        var DateTimeAnalyzer = _p.r(73);
        var CurrencyAnalyzer = _p.r(72);
        var PercentAnalyzer = _p.r(76);
        var FractionAnalyzer = _p.r(74);
        var CodeParser = _p.r(65);
        var CODE_FLAG = _p.r(64);
        return {
...
_p[81] = {
    value: function(require) {
        var CodeParser = _p.r(65);
        var DecimalFormatter = _p.r(83);
        var ScientificFormatter = _p.r(85);
        var DateTimeFormatter = _p.r(82);
        var FractionFormatter = _p.r(84);
        var CODE_FLAG = _p.r(64);
        var FORMAT_CODE = _p.r(93);
        return {
...
_p[87] = {
    value: function(require) {
        ...
        var NUMBER_FORMAT = _p.r(96);
        var Format = _p.r(78);
        var Formatter = _p.r(80);
        var ColorManager = _p.r(66);
...
_p[100] = {
    value: function(require) {
        var Container = _p.r(103);
        var ElementFactory = _p.r(104);
        var Service = _p.r(107);
        var Command = _p.r(102);
        var Message = _p.r(105);
        var RefreshManager = _p.r(106);
        var Configure = _p.r(99);
        var ModuleLoader = _p.r(108);
        var PluginWrapper = _p.r(109);
...
_p[122] = {
    value: function(require) {
        ...
        var STYLE_GROUP = _p.r(153).styleGroup;
        var DEFAULT_STYLE_VALUE = _p.r(125);
        var FORMAT_CODE = _p.r(93);
        var VALUE_FILTER = _p.r(121);
        var FORMAT_CODE_MAP = {};
        for (var key in FORMAT_CODE) {
            if (FORMAT_CODE.hasOwnProperty(key) && key !== "_default") {
                FORMAT_CODE_MAP[FORMAT_CODE[key]] = key;
...
_p[126] = {
    value: function(require) {
        var MAX_COLUMN_COUNT = _p.r(149).MAX_COLUMN_COUNT;
        return {
...
_p[137] = {
    value: function(require) {
        var StyleCommand = _p.r(134);
        var ResizeCommand = _p.r(133);
        var ClearCommand = _p.r(130);
        var WriteCommand = _p.r(135);
        var ExportCommand = _p.r(131);
        var PasteCommand = _p.r(132);
        return {
            write: WriteCommand,
...
_p[138] = {
    value: function(require) {
        ...
        }, _p.r(126), _p.r(147), _p.r(144), _p.r(140), _p.r(145), _p.r(148), _p.r(143), _p.r(139), _p.r(141), _p.r(142), _p.r(145), _p.r(139));
    }
};
...
_p[145] = {
    value: function(require) {
        var StyleUtil = _p.r(146);
        var APPLY_CLASSIFY = _p.r(151).applyName;
        return {
...
_p[148] = {
    value: function(require) {
        ...
        var XF_STYLE_DEFAULT = _p.r(150).xfStyle;
        return {
...
_p[159] = {
    value: function(require) {
        var StandardStyle = _p.r(161);
        var INLINE_ELEMENTS = _p.r(160);
        var ELEMENT_BLACKLIST = _p.r(155);
        var DEFAULT_ELEMENT_STYLE = _p.r(157);
        var BASE_FONT_SIZE = 13;
...
_p[178] = {
    value: function(require) {
        ...
        }, _p.r(177), _p.r(173), _p.r(174), _p.r(176)));
    }
};
...
_p[188] = {
    value: function(require) {
        var ContentFillPainter = _p.r(190);
        var ContentPainter = _p.r(191);
        var MergeFillPainter = _p.r(192);
        var CellFillPainter = _p.r(189);
        var GridPainter = _p.r(186);
        var BorderPainter = _p.r(184);
        var BoxPainter = _p.r(185);
        var PaneLinePainter = _p.r(187);
        return {
...
_p[195] = {
    value: function(require) {
        var BodyScreen = _p.r(182);
        var TopScreen = _p.r(196);
        var LeftScreen = _p.r(194);
...
_p[199] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(198);
...
_p[203] = {
    value: function(require) {
        var $ = _p.r(2);
        var Util = _p.r(175);
        var NormalWorker = _p.r(201);
        var PaneWorker = _p.r(202);
...
_p[204] = {
    value: function(require) {
        var $ = _p.r(2);
        var CELL_VALUE_TYPE = _p.r(91);
        var BOOLEAN_VALUE = _p.r(94);
        return _p.r(0).create("Cell", {
            base: _p.r(115),
            init: function() {
                this.initService();
...
_p[206] = {
    value: function(require) {
        ...
        BTable.module(_p.r(154));
        BTable.mapEvent(_p.r(110));
        BTable.Interpreter = _p.r(136);
        BTable.ExcelAdapter = _p.r(119);
