...
_p[8] = {
    value: function(require) {
        ...
        var PARSED_TYPE = _p.r(28);
        var ERROR = _p.r(13);
        var RangeAnalyzer = _p.r(26);
        var OperatorAnalyzer = _p.r(25);
        var currentTokens;
        return {
...
_p[16] = {
    value: function(require) {
        var TYPE = _p.r(28);
        var BOOLEAN_VALUE = _p.r(10);
        var ErrorCreator = _p.r(12);
        return {
            exec: function() {
...
_p[25] = {
    value: function(require) {
        var TYPE = _p.r(22).TYPE;
        var NEW_TYPE = _p.r(28);
        return {
...
_p[50] = {
    value: function(require) {
        var StructFacade = _p.r(49);
        var Parser = _p.r(48);
        var basic = _p.r(43);
        var LOCAL_CONFIG = _p.r(30);
...
_p[52] = {
    value: function(require) {
        var DEFAULT_FORMAT = _p.r(51);
        var TYPE_STYLE = _p.r(53);
...
_p[54] = {
    value: function(require) {
        var CELL_VALUE_TYPE = _p.r(64);
        var CELL_MODEL = _p.r(55);
        var BOOLEAN_VALUE = _p.r(63);
        var GeneralFormatter = _p.r(58);
        var NumericFormatter = _p.r(59);
        return {
            //getType: function (row, col) {
            //
...
_p[68] = {
    value: function(require) {
        var Container = _p.r(71);
        var ElementFactory = _p.r(72);
        var Service = _p.r(75);
        var Command = _p.r(70);
        var Message = _p.r(73);
        var RefreshManager = _p.r(74);
        var Configure = _p.r(67);
        var ModuleLoader = _p.r(76);
        var PluginWrapper = _p.r(77);
...
_p[96] = {
    value: function(require) {
        var StyleCommand = _p.r(93);
        var ResizeCommand = _p.r(92);
        var ClearCommand = _p.r(90);
        var WriteCommand = _p.r(94);
        var ExportCommand = _p.r(91);
        return {
            write: WriteCommand,
...
_p[97] = {
    value: function(require) {
        ...
        var ESCAPE_MAP = _p.r(88);
        var UNESCAPE_MAP = _p.r(99);
...
_p[110] = {
    value: function(require) {
        var $ = _p.r(2);
        var KEY_CODE = _p.r(111);
        var InputShadowMan = _p.r(109);
        var TextHelper = _p.r(112);
        var BORDER_WIDTH = 2;
        var PADDING = 2;
...
_p[121] = {
    value: function(require) {
        var $ = _p.r(2);
        var CONTENT = _p.r(122);
        var BG_CONTENT = _p.r(120);
        var BG_CELL = _p.r(117);
        var CENTER_CONTENT = _p.r(119);
        var CENTER_BG_CONTENT = _p.r(118);
        var PADDING = 2;
        var PATTERN = /\$\{([^\}]+)\}/g;
        var LOCAL_COFNIG = _p.r(30);
        var BORDER_WIDTH = _p.r(31).border.width;
...
_p[126] = {
    value: function(require) {
        var BodyScreen = _p.r(116);
        var TopScreen = _p.r(127);
        var LeftScreen = _p.r(125);
        var GridScreen = _p.r(124);
...
_p[129] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(128);
...
_p[132] = {
    value: function(require) {
        ...
        BTalbe.module(_p.r(100));
        BTalbe.mapEvent(_p.r(78));
        BTalbe.Interpreter = _p.r(95);
