    ...
    value: function(require) {
        ...
        return {
            draw: function(canvas, struct) {
                ...
                canvas.save();
                drawBorders(canvas, struct, borders);
                canvas.restore();
            }
        };
        function drawBorders(canvas, struct, borders) {
            var rowBorders;
            var current;
            for (var i = 0, len = borders.length; i < len; i++) {
                ...
                for (var j = 0, jlen = rowBorders.length; j <= jlen; j++) {
                    ...
                    drawBorder(canvas, struct, current, i, j);
                }
            }
        }
        function drawBorder(canvas, struct, borderIndex, rowIndex, colIndex) {
...
_p[178] = {
    value: function(require) {
        ...
        function render(canvas, struct, region) {
            ...
            drawBorders(canvas, struct, borders, region);
        }
        function drawBorders(canvas, struct, borders, region) {
            var rowBorders;
            var current;
            ...
            for (var i = 0, len = borders.length; i < len; i++) {
                ...
                for (var j = 0, jlen = rowBorders.length; j <= jlen; j++) {
                    ...
                    drawBorder(canvas, struct, current, startRow + i, startCol + j);
                }
            }
        }
        function drawBorder(canvas, struct, borderIndex, rowIndex, colIndex) {
    ...
    value: function(require) {
        ...
        return {
            draw: function(canvas, contentCanvas, struct) {
                ...
                BorderPainter.draw(canvas, struct, regions);
