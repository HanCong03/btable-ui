...
_p[51] = {
    value: function(require) {
        var basic = _p.r(50);
        var DataHelper = _p.r(52);
        // TODO 解决引用问题
        var KernelHelper = _p.r(104);
        var CONFIG = _p.r(33);
...
_p[64] = {
    value: function(require) {
        var CELL_VALUE_TYPE = _p.r(77);
        var NUMBERS_FORMAT = _p.r(78);
        var BOOLEAN_VALUE = _p.r(76);
        var NumericAnalyzer = _p.r(66);
        var DateTimeAnalyzer = _p.r(65);
        return {
            /**
...
_p[69] = {
    value: function(require) {
        var FormatAnalyzer = _p.r(64);
        var DateTimeConverter = _p.r(68);
        var NumericFormat = _p.r(70);
...
_p[82] = {
    value: function(require) {
        var Container = _p.r(85);
        var ElementFactory = _p.r(86);
        var Service = _p.r(89);
        var Command = _p.r(84);
        var Message = _p.r(87);
        var RefreshManager = _p.r(88);
        var Configure = _p.r(81);
        var ModuleLoader = _p.r(90);
        var PluginWrapper = _p.r(91);
...
_p[103] = {
    value: function(require) {
        var MAX_COLUMN_COUNT = _p.r(119).MAX_COLUMN_COUNT;
        return {
...
_p[114] = {
    value: function(require) {
        var StyleCommand = _p.r(111);
        var ResizeCommand = _p.r(110);
        var ClearCommand = _p.r(107);
        var WriteCommand = _p.r(112);
        var ExportCommand = _p.r(108);
        var PasteCommand = _p.r(109);
        return {
            write: WriteCommand,
...
_p[115] = {
    value: function(require) {
        var MIN_SIZE = 5;
        var ESCAPE_MAP = _p.r(102);
        var UNESCAPE_MAP = _p.r(121);
        var HASH = _p.r(103);
        var KernelHelper = _p.r(104);
        return $.extend({
            /* ---------------- read ---------------- */
            ...
            kernelBatchSetSameStyle: function(style, range) {
                var styleData = this.data.style;
                var index;
                for (var i = range.start.row, limit = range.end.row; i <= limit; i++) {
                    for (var j = range.start.col, jlimit = range.end.col; j <= jlimit; j++) {
                        ...
                        for (var key in style) {
                            if (style.hasOwnProperty(key)) {
                                styleData[ESCAPE_MAP[key]][index] = style[key];
                            }
                        }
                    }
                }
        ...
        }, _p.r(103), _p.r(116), _p.r(120), _p.r(117), _p.r(118));
    }
};
    ...
    value: function(require) {
         ...
         */
            __kernelResetUnmergeCellSetting: function(start, end) {
                ...
                this.kernelBatchSetSameStyle(rootStyle, {
                    start: start,
                    end: end
                });
            },
...
_p[127] = {
    value: function(require) {
        var StandardStyle = _p.r(129);
        var INLINE_ELEMENTS = _p.r(128);
        var ELEMENT_BLACKLIST = _p.r(123);
        var DEFAULT_ELEMENT_STYLE = _p.r(125);
...
_p[141] = {
    value: function(require) {
        var $ = _p.r(2);
        var KEY_CODE = _p.r(136);
        var InputShadowMan = _p.r(140);
        var TextHelper = _p.r(142);
...
_p[146] = {
    value: function(require) {
        var Canvas = _p.r(156);
        var CellGrid = _p.r(147);
        var Painter = _p.r(152);
        var LinePainter = _p.r(148);
        return _p.r(0).create("BodyScreen", {
            ...
            render: function() {
                ...
                LinePainter.draw(this.canvas, struct);
                this.__toggle();
            },
            __toggle: function() {
...
//src/system/screen/body/line-painter.js
/**
 * @file
 * @author hancong03@baiud.com
 */
_p[148] = {
    value: function(require) {
        var GridPainter = _p.r(151);
        var BorderPainter = _p.r(149);
        var BoxPainter = _p.r(150);
        return {
...
_p[152] = {
    value: function(require) {
        ...
        var Canvas = _p.r(156);
        var ContentFillPainter = _p.r(154);
        var ContentPainter = _p.r(155);
        var CellFillPainter = _p.r(153);
...
_p[158] = {
    value: function(require) {
        var BodyScreen = _p.r(146);
        var TopScreen = _p.r(159);
        var LeftScreen = _p.r(157);
...
_p[161] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(160);
...
_p[165] = {
    value: function(require) {
        ...
        BTable.module(_p.r(122));
        BTable.mapEvent(_p.r(92));
        BTable.Interpreter = _p.r(113);
