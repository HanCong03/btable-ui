...
_p[4] = {
    value: function(require, exports, module) {
        var Context = _p.r(114);
        var FORMAT_CODE = _p.r(107);
        var codes = {};
...
_p[47] = {
    value: function(require) {
        var Parser = _p.r(64);
        var CellRelation = _p.r(46);
        var MathRuntime = _p.r(58);
...
_p[48] = {
    value: function() {
        return {
            _all: true,
            _error: true,
            exec: function(operands, F_VALUE_TYPE) {
                var operand;
                var sum = 0;
                var midleValue;
...
_p[51] = {
    value: function(require) {
        var ERROR_VALUE = _p.r(106);
        var F_VALUE_TYPE = _p.r(41);
        var OPERAND_TYPE = _p.r(42);
        var ComparisonRuntime = _p.r(52);
        var TypeCast = _p.r(59);
        var FormulaUtils = _p.r(60);
        return {
...
_p[54] = {
    value: function(require) {
        var ERROR_VALUE = _p.r(106);
        var CELL_TYPE = _p.r(105);
        var TOKEN = _p.r(43);
        var TOKEN_SUBTYPE = TOKEN.SUBTYPE;
        var ComparisonRuntime = _p.r(55);
        var TypeCast = _p.r(59);
        return {
...
_p[56] = {
    value: function(require) {
        var ERROR_VALUE = _p.r(106);
        var F_VALUE_TYPE = _p.r(41);
        var FunctionManager = _p.r(50);
        var ValueReader = _p.r(67);
        return {
            exec: function(valueModule, fun, operands, start, end) {
                ...
                var result = fun.exec(operands, F_VALUE_TYPE);
                // 对结果数组进行标准化
...
_p[58] = {
    value: function(require) {
        var TOKEN = _p.r(43);
        var TOKEN_TYPE = TOKEN.TYPE;
        var FunctionRuntime = _p.r(56);
        var ArrayBasicRuntime = _p.r(51);
        var ResultAnalyzer = _p.r(57);
        var ArrayResultAnalyzer = _p.r(53);
...
_p[64] = {
    value: function(require) {
        var TokenAnalyzer = _p.r(66);
        var CellsParser = _p.r(62);
        var RPNParser = _p.r(65);
        var CellReferenceParser = _p.r(61);
        var OperandParser = _p.r(63);
        return {
            parse: function(text) {
...
_p[80] = {
    value: function(require) {
        var CELL_TYPE = _p.r(105);
        var NumberFormatter = _p.r(95);
        var LOGICAL_VALUE = _p.r(108);
        var CodeParser = _p.r(79);
...
_p[82] = {
    value: function(require) {
        var CELL_TYPE = _p.r(105);
        var NumberAnalyzer = _p.r(85);
        var LogicalAnalyzer = _p.r(84);
        var ErrorAnalyzer = _p.r(83);
        return {
            exec: function(content, numberFormatCode) {
                var result;
                if (!content) {
...
_p[85] = {
    value: function(require) {
        var NumericAnalyzer = _p.r(89);
        var DateTimeAnalyzer = _p.r(87);
        var CurrencyAnalyzer = _p.r(86);
        var PercentAnalyzer = _p.r(90);
        var FractionAnalyzer = _p.r(88);
        var CodeParser = _p.r(79);
        var CODE_FLAG = _p.r(78);
        return {
...
_p[95] = {
    value: function(require) {
        var CodeParser = _p.r(79);
        var DecimalFormatter = _p.r(97);
        var ScientificFormatter = _p.r(99);
        var DateTimeFormatter = _p.r(96);
        var FractionFormatter = _p.r(98);
        var CODE_FLAG = _p.r(78);
        var FORMAT_CODE = _p.r(107);
        return {
...
_p[101] = {
    value: function(require) {
        ...
        var NUMBER_FORMAT = _p.r(110);
        var Format = _p.r(92);
        var Formatter = _p.r(94);
        var ColorManager = _p.r(80);
...
_p[114] = {
    value: function(require) {
        var Container = _p.r(117);
        var ElementFactory = _p.r(118);
        var Service = _p.r(121);
        var Command = _p.r(116);
        var Message = _p.r(119);
        var RefreshManager = _p.r(120);
        var Configure = _p.r(113);
        var ModuleLoader = _p.r(122);
        var PluginWrapper = _p.r(123);
...
_p[136] = {
    value: function(require) {
        ...
        var STYLE_GROUP = _p.r(168).styleGroup;
        var DEFAULT_STYLE_VALUE = _p.r(139);
        var FORMAT_CODE = _p.r(107);
        var VALUE_FILTER = _p.r(135);
        var FORMAT_CODE_MAP = {};
        for (var key in FORMAT_CODE) {
            if (FORMAT_CODE.hasOwnProperty(key) && key !== "_default") {
                FORMAT_CODE_MAP[FORMAT_CODE[key]] = key;
...
_p[140] = {
    value: function(require) {
        var MAX_COLUMN_COUNT = _p.r(164).MAX_COLUMN_COUNT;
        return {
...
_p[151] = {
    value: function(require) {
        var StyleCommand = _p.r(148);
        var ResizeCommand = _p.r(147);
        var ClearCommand = _p.r(144);
        var WriteCommand = _p.r(149);
        var ExportCommand = _p.r(145);
        var PasteCommand = _p.r(146);
        return {
            write: WriteCommand,
...
_p[152] = {
    value: function(require) {
        ...
        }, _p.r(140), _p.r(162), _p.r(159), _p.r(155), _p.r(160), _p.r(163), _p.r(158), _p.r(153), _p.r(156), _p.r(157), _p.r(160), _p.r(153), _p.r(154));
    }
};
...
_p[160] = {
    value: function(require) {
        var StyleUtil = _p.r(161);
        var APPLY_CLASSIFY = _p.r(166).applyName;
        return {
...
_p[163] = {
    value: function(require) {
        ...
        var XF_STYLE_DEFAULT = _p.r(165).xfStyle;
        return {
    ...
    value: function(require) {
        return {
            ...
            core: {
                ...
                visible: _p.r(103),
                device: _p.r(44),
                exportManager: _p.r(45),
                wraptext: _p.r(104),
                autosize: _p.r(16),
                formula: _p.r(47),
                valueSecurity: _p.r(77),
                mode: _p.r(69)
            },
            system: {
                screen: _p.r(210),
...
_p[174] = {
    value: function(require) {
        var StandardStyle = _p.r(176);
        var INLINE_ELEMENTS = _p.r(175);
        var ELEMENT_BLACKLIST = _p.r(170);
        var DEFAULT_ELEMENT_STYLE = _p.r(172);
        var BASE_FONT_SIZE = 13;
...
_p[193] = {
    value: function(require) {
        ...
        }, _p.r(192), _p.r(188), _p.r(189), _p.r(191)));
    }
};
...
_p[203] = {
    value: function(require) {
        var ContentFillPainter = _p.r(205);
        var ContentPainter = _p.r(206);
        var MergeFillPainter = _p.r(207);
        var CellFillPainter = _p.r(204);
        var GridPainter = _p.r(201);
        var BorderPainter = _p.r(199);
        var BoxPainter = _p.r(200);
        var PaneLinePainter = _p.r(202);
        return {
...
_p[210] = {
    value: function(require) {
        var BodyScreen = _p.r(197);
        var TopScreen = _p.r(211);
        var LeftScreen = _p.r(209);
...
_p[214] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(213);
...
_p[218] = {
    value: function(require) {
        var $ = _p.r(2);
        var Util = _p.r(190);
        var NormalWorker = _p.r(216);
        var PaneWorker = _p.r(217);
...
_p[219] = {
    value: function(require) {
        var $ = _p.r(2);
        var CELL_VALUE_TYPE = _p.r(105);
        var BOOLEAN_VALUE = _p.r(108);
        return _p.r(0).create("Cell", {
            base: _p.r(129),
            init: function() {
                this.initService();
...
_p[221] = {
    value: function(require) {
        ...
        BTable.module(_p.r(169));
        BTable.mapEvent(_p.r(124));
        BTable.Interpreter = _p.r(150);
        BTable.ExcelAdapter = _p.r(133);
