    ...
    value: function(require) {
        ...
        return _p.r(0).create("Painter", {
            ...
            draw: function(canvas, contentCanvas, struct, cellGrid) {
                ...
                var contentLayout = ContentPainter.draw(contentCanvas, layout);
            ...
            draw: function(canvas, layout) {
                ...
                for (var i = 0, len = layout.length; i < len; i++) {
                    ...
                    for (var j = 0, jlen = rowLayout.length; j < jlen; j++) {
                        ...
                        //if (currentLayout.row === 2 && currentLayout.col === 0) {
                        //    debugger;
                        //}
                        ...
                        if (currentLayout.type === "mergecell") {
                            ...
                            currentContentLayout.push(drawMergeCellContent(canvas, currentLayout));
                        } else {
