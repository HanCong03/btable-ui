    ...
    value: function(require) {
        ...
        return _p.r(0).create("InputWorker", $.extend({
            ...
            addFaildState: function() {
                ...
                this.selectionModule.addFaildState();
            },
            removeFaildState: function() {
                ...
                this.selectionModule.removeFaildState();
            },
            write: function() {
            ...
            updateStyle: function() {
                ...
                var alignmentStyle = struct.getComputedStyle("alignments", activeCell.row, activeCell.col);
                this.$inputNode.css({
...
_p[188] = {
    value: function(require) {
        ...
        var Selection = _p.r(0).create("Selection", {
            ...
            addFaildState: function() {
                this.$selectionNode.addClass("btb-selection-faild");
            },
            removeFaildState: function() {
                this.$selectionNode.removeClass("btb-selection-faild");
            },
            unstable: function() {
