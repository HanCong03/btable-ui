...
_p[4] = {
    value: function(require, exports, module) {
        var Context = _p.r(128);
        var FORMAT_CODE = _p.r(121);
...
_p[41] = {
    value: function(require) {
        ...
        }, _p.r(169), _p.r(46), _p.r(44), _p.r(42), _p.r(43), _p.r(47), _p.r(45)));
    }
};
...
_p[56] = {
    value: function(require) {
        var Parser = _p.r(76);
        var CellRelation = _p.r(55);
        var MathRuntime = _p.r(70);
...
_p[63] = {
    value: function(require) {
        var ERROR_VALUE = _p.r(120);
        var F_VALUE_TYPE = _p.r(49);
        var OPERAND_TYPE = _p.r(50);
        var ComparisonRuntime = _p.r(64);
        var TypeCast = _p.r(71);
        var FormulaUtils = _p.r(72);
        return {
...
_p[68] = {
    value: function(require) {
        var ERROR_VALUE = _p.r(120);
        var F_VALUE_TYPE = _p.r(49);
        var FunctionManager = _p.r(62);
        var ValueReader = _p.r(79);
        return {
...
_p[70] = {
    value: function(require) {
        var TOKEN = _p.r(51);
        var TOKEN_TYPE = TOKEN.TYPE;
        var FunctionRuntime = _p.r(68);
        var ArrayBasicRuntime = _p.r(63);
        var ResultAnalyzer = _p.r(69);
        var ArrayResultAnalyzer = _p.r(65);
...
_p[76] = {
    value: function(require) {
        var TokenAnalyzer = _p.r(78);
        var CellsParser = _p.r(74);
        var RPNParser = _p.r(77);
        var CellReferenceParser = _p.r(73);
        var OperandParser = _p.r(75);
        return {
            parse: function(text) {
...
_p[94] = {
    value: function(require) {
        var CELL_TYPE = _p.r(119);
        var NumberFormatter = _p.r(109);
        var LOGICAL_VALUE = _p.r(122);
        var CodeParser = _p.r(93);
...
_p[96] = {
    value: function(require) {
        var CELL_TYPE = _p.r(119);
        var NumberAnalyzer = _p.r(99);
        var LogicalAnalyzer = _p.r(98);
        var ErrorAnalyzer = _p.r(97);
        return {
            exec: function(content, numberFormatCode) {
                var result;
                if (!content) {
...
_p[99] = {
    value: function(require) {
        var NumericAnalyzer = _p.r(103);
        var DateTimeAnalyzer = _p.r(101);
        var CurrencyAnalyzer = _p.r(100);
        var PercentAnalyzer = _p.r(104);
        var FractionAnalyzer = _p.r(102);
        var CodeParser = _p.r(93);
        var CODE_FLAG = _p.r(92);
        return {
...
_p[101] = {
    value: function(require) {
        var CELL_TYPE = _p.r(119);
        var NUMBER_FORMAT = _p.r(124);
        var DateTimeConverter = _p.r(105);
        var FORMAT_CODE = _p.r(121);
        var MAX_YEAR = 9999;
        var MIN_YEAR = 1900;
        return {
...
_p[109] = {
    value: function(require) {
        var CodeParser = _p.r(93);
        var DecimalFormatter = _p.r(111);
        var ScientificFormatter = _p.r(113);
        var DateTimeFormatter = _p.r(110);
        var FractionFormatter = _p.r(112);
        var CODE_FLAG = _p.r(92);
        var FORMAT_CODE = _p.r(121);
        return {
...
_p[115] = {
    value: function(require) {
        ...
        var NUMBER_FORMAT = _p.r(124);
        var Format = _p.r(106);
        var Formatter = _p.r(108);
        var ColorManager = _p.r(94);
        var Value = _p.r(0).create("Value", {
            dataAccess: null,
            formulaModule: null,
            rangeFacade: null,
...
_p[128] = {
    value: function(require) {
        var Container = _p.r(131);
        var ElementFactory = _p.r(132);
        var Service = _p.r(135);
        var Command = _p.r(130);
        var Message = _p.r(133);
        var RefreshManager = _p.r(134);
        var Configure = _p.r(127);
        var ModuleLoader = _p.r(136);
        var PluginWrapper = _p.r(137);
...
_p[150] = {
    value: function(require) {
        ...
        var STYLE_GROUP = _p.r(193).styleGroup;
        var DEFAULT_STYLE_VALUE = _p.r(154);
        var FORMAT_CODE = _p.r(121);
        var VALUE_FILTER = _p.r(149);
        var FORMAT_CODE_MAP = {};
        for (var key in FORMAT_CODE) {
            if (FORMAT_CODE.hasOwnProperty(key) && key !== "_default") {
                FORMAT_CODE_MAP[FORMAT_CODE[key]] = key;
...
_p[157] = {
    value: function(require) {
        var MAX_COLUMN_COUNT = _p.r(189).MAX_COLUMN_COUNT;
        return {
...
_p[168] = {
    value: function(require) {
        var StyleCommand = _p.r(165);
        var ResizeCommand = _p.r(164);
        var ClearCommand = _p.r(161);
        var WriteCommand = _p.r(166);
        var ExportCommand = _p.r(162);
        var PasteCommand = _p.r(163);
        return {
            write: WriteCommand,
...
_p[169] = {
    value: function(require) {
        ...
        }, _p.r(157), _p.r(186), _p.r(182), _p.r(177), _p.r(187), _p.r(184), _p.r(183), _p.r(188), _p.r(180), _p.r(170), _p.r(178), _p.r(179), _p.r(184), _p.r(170), _p.r(175), _p.r(171), _p.r(174), _p.r(173), _p.r(176), _p.r(181));
    }
};
...
_p[172] = {
    value: function() {
        return {
            kernelSetValidation: function(start, end, options) {}
        };
    }
};
...
_p[184] = {
    value: function(require) {
        var StyleUtil = _p.r(185);
        var APPLY_CLASSIFY = _p.r(191).applyName;
        return {
...
_p[188] = {
    value: function(require) {
        ...
        var XF_STYLE_DEFAULT = _p.r(190).xfStyle;
        return {
    ...
    value: function(require) {
        return {
            ...
            core: {
                ...
                visible: _p.r(117),
                device: _p.r(52),
                exportManager: _p.r(53),
                wraptext: _p.r(118),
                autosize: _p.r(16),
                formula: _p.r(56),
                valueSecurity: _p.r(91),
                mode: _p.r(82),
                comments: _p.r(38),
                paster: _p.r(83),
                header: _p.r(80)
...
_p[200] = {
    value: function(require) {
        var HTMLConverter = _p.r(201);
        var PlaintextConverter = _p.r(204);
        var OutConverter = _p.r(203);
...
_p[201] = {
    value: function(require) {
        var ELEMENT = 1;
        var TEXT = 3;
        var ROW_ELEMENTS = _p.r(205);
        var IGNORE_ELEMENTS = _p.r(202);
        return _p.r(0).create("Converter", {
            shadowNode: null,
            base: _p.r(140),
            init: function() {
...
_p[216] = {
    value: function(require) {
        ...
        }, _p.r(215), _p.r(211), _p.r(212), _p.r(214)));
    }
};
...
_p[226] = {
    value: function(require) {
        var ContentFillPainter = _p.r(229);
        var ContentPainter = _p.r(230);
        var MergeFillPainter = _p.r(231);
        var CellFillPainter = _p.r(227);
        var Commentspainter = _p.r(228);
        var GridPainter = _p.r(224);
        var BorderPainter = _p.r(222);
        var BoxPainter = _p.r(223);
        var PaneLinePainter = _p.r(225);
        return {
...
_p[234] = {
    value: function(require) {
        var BodyScreen = _p.r(220);
        var TopScreen = _p.r(235);
        var LeftScreen = _p.r(233);
...
_p[238] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(237);
...
_p[242] = {
    value: function(require) {
        var $ = _p.r(2);
        var Util = _p.r(213);
        var NormalWorker = _p.r(240);
        var PaneWorker = _p.r(241);
...
_p[243] = {
    value: function(require) {
        var $ = _p.r(2);
        var CELL_VALUE_TYPE = _p.r(119);
        var BOOLEAN_VALUE = _p.r(122);
        return _p.r(0).create("Cell", {
            base: _p.r(143),
            init: function() {
                this.initService();
...
_p[245] = {
    value: function(require) {
        ...
        BTable.module(_p.r(194));
        BTable.mapEvent(_p.r(138));
        BTable.Interpreter = _p.r(167);
        BTable.ExcelAdapter = _p.r(147);
