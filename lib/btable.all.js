...
_p[143] = {
    value: function(require) {
        ...
        function setBorderStyle(canvas, borderType, data, start, end) {
            switch (data.style) {
              case "thin":
              ...
              case "dashed":
                drawDashed(canvas, 3, data.color, borderType, start, end);
                break;

              case "dotted":
                drawDashed(canvas, 1, data.color, borderType, start, end);
                break;
            }
        }
        ...
        function drawDashed(canvas, interval, color, borderType, start, end) {
            if (borderType === "h") {
                drawHDashed(canvas, interval, color, start.x, end.x, start.y);
            } else {
                drawVDashed(canvas, interval, color, start.y, end.y, start.x);
            }
        }
        function drawHDashed(canvas, interval, color, start, end, y) {
    ...
    value: function(require) {
        ...
        return _p.r(0).create("BodyScreen", {
            ...
            render: function() {
                ...
                // end draw line grid
                canvas.stroke();
                canvas.strokeStyle(sysStyle.backgroundColor);
                canvas.beginPath();
                var rowBorders;
                var currentBorder;
                for (var i = 0, len = borders.length; i < len; i++) {
