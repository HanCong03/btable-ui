    ...
    value: function(require) {
        ...
        var Actuary = _p.r(0).create("Actuary", {
            ...
            getNormalGrid: function(paneGrid) {
                ...
                var cellConfig = this.cellConfig;
                if (this.reverse.row) {
                    this.resetViewStartRow(paneGrid);
                }
                if (this.reverse.col) {
                    this.resetViewStartCol(paneGrid);
                }
                var space = dataAccess.getSpace();
            ...
            resetViewStartRow: function(paneGrid) {
                var dataAccess = this.dataAccess;
                var autosize = this.autosize;
                var cellConfig = this.cellConfig;
                var space = dataAccess.getSpace();
                ...
                if (paneGrid.rowIndex === -1) {
                    ...
                    spaceHeight -= paneGrid.row[paneGrid.rowIndex + 1] - offset;
                }
                if (endRow >= total.row) {
                    endRow = total.row - 1;
                }
                ...
                dataAccess.setViewStartRow(endRow + 1 - tmpHeights.length - (paneGrid.rowIndex + 1));
            },
            resetViewStartCol: function(paneGrid) {
                var dataAccess = this.dataAccess;
                var cellConfig = this.cellConfig;
                var space = dataAccess.getSpace();
                var total = dataAccess.getTotal();
                ...
                if (paneGrid.colIndex === -1) {
                    ...
                    spaceWidth -= paneGrid.col[paneGrid.colIndex + 1] - offset;
                }
                if (endCol >= total.col) {
                    endCol = total.col - 1;
                }
                if (endCol === total.row - 1) {
                ...
                dataAccess.setViewStartCol(endCol + 1 - tmpWidths.length - (paneGrid.colIndex + 1));
            },
...
_p[29] = {
    value: function(require) {
        return _p.r(0).create("ScrollCommand", {
            base: _p.r(92),
            name: "scroll scrollto scrollrowto scrollcolumnto scrollrow scrollcolumn",
...
_p[40] = {
    value: function(require) {
        ...
        var Range = _p.r(0).create("Range", {
            ...
            selectAll: function() {
                var totalIndex = this.dataAccess.getTotalIndex();
                this.selectColumn(0, totalIndex.col);
            },
            selectRow: function(startIndex, endIndex) {
                var totalIndex = this.dataAccess.getTotalIndex();
            ...
            moveDown: function(count) {
                ...
                if (this.cell.isMergeCell(original.row, original.col)) {
                    mergeCell = this.cell.getMergeCell(original.row, original.col);
...
_p[81] = {
    value: function(require) {
        var Container = _p.r(84);
        var ElementFactory = _p.r(85);
        var Service = _p.r(88);
        var Command = _p.r(83);
        var Message = _p.r(86);
        var RefreshManager = _p.r(87);
        var Configure = _p.r(80);
        var ModuleLoader = _p.r(89);
        var PluginWrapper = _p.r(90);
...
_p[103] = {
    value: function(require) {
        ...
        var STYLE_GROUP = _p.r(135).styleGroup;
        var DEFAULT_STYLE_VALUE = _p.r(106);
        var FORMAT_CODE = _p.r(74);
        var VALUE_FILTER = _p.r(102);
        var FORMAT_CODE_MAP = {};
        for (var key in FORMAT_CODE) {
            if (FORMAT_CODE.hasOwnProperty(key) && key !== "_default") {
                FORMAT_CODE_MAP[FORMAT_CODE[key]] = key;
...
_p[108] = {
    value: function(require) {
        var MAX_COLUMN_COUNT = _p.r(131).MAX_COLUMN_COUNT;
        return {
...
_p[119] = {
    value: function(require) {
        var StyleCommand = _p.r(116);
        var ResizeCommand = _p.r(115);
        var ClearCommand = _p.r(112);
        var WriteCommand = _p.r(117);
        var ExportCommand = _p.r(113);
        var PasteCommand = _p.r(114);
        return {
            write: WriteCommand,
...
_p[120] = {
    value: function(require) {
        ...
        return $.extend({
            ...
            kernelSetColumnWidth: function(value, col) {
                ...
                if (!value) {
                    ...
                    activeData.column[col] = Math.max(value, MIN_SIZE);
                }
            },
            kernelSetRowHeight: function(value, row) {
                ...
                if (!value) {
                    ...
                    activeData.row[row] = Math.max(value, MIN_SIZE);
                }
            },
        ...
        }, _p.r(108), _p.r(129), _p.r(126), _p.r(122), _p.r(127), _p.r(130), _p.r(125), _p.r(121), _p.r(123), _p.r(124), _p.r(127), _p.r(121));
    }
};
...
_p[127] = {
    value: function(require) {
        var StyleUtil = _p.r(128);
        var APPLY_CLASSIFY = _p.r(133).applyName;
        return {
...
_p[130] = {
    value: function(require) {
        ...
        var XF_STYLE_DEFAULT = _p.r(132).xfStyle;
        return {
...
_p[142] = {
    value: function(require) {
        var StandardStyle = _p.r(144);
        var INLINE_ELEMENTS = _p.r(143);
        var ELEMENT_BLACKLIST = _p.r(138);
        var DEFAULT_ELEMENT_STYLE = _p.r(140);
        var BASE_FONT_SIZE = 13;
    ...
    value: function(require) {
        ...
        var Util = {
            getMergeCellVisibleRect: function(struct, mergeInfo) {
                ...
                if (pane.row === -1 && pane.col === -1) {
                    return Util.getRect(struct, mergeInfo.start, mergeInfo.end);
                } else {
        ...
        function getPaneSelectionRect(struct, start, end) {
            ...
            if (rMap[startRow] === undefined) {
                result.borderTopStyle = "none";
            }
            if (rMap[endRow] === undefined) {
                result.borderBottomStyle = "none";
            }
            if (cMap[startCol] === undefined) {
                result.borderLeftStyle = "none";
            }
            if (cMap[endCol] === undefined) {
                result.borderRightStyle = "none";
            }
            return result;
        }
...
_p[166] = {
    value: function(require) {
        var Canvas = _p.r(186);
        var CellGrid = _p.r(167);
        var Painter = _p.r(171);
        return _p.r(0).create("BodyScreen", {
            panel: null,
            width: 0,
            height: 0,
...
_p[171] = {
    value: function(require) {
        var ContentFillPainter = _p.r(173);
        var ContentPainter = _p.r(174);
        var MergeFillPainter = _p.r(175);
        var CellFillPainter = _p.r(172);
        var GridPainter = _p.r(170);
        var BorderPainter = _p.r(168);
        var BoxPainter = _p.r(169);
        var PaneLinePainter = _p.r(165);
        return {
            draw: function(canvas, contentCanvas, struct) {
...
_p[176] = {
    value: function(require) {
        var NormalPainter = _p.r(171);
        var PanePainter = _p.r(181);
...
_p[181] = {
    value: function(require) {
        var ContentFillPainter = _p.r(183);
        var ContentPainter = _p.r(184);
        var MergeFillPainter = _p.r(185);
        var CellFillPainter = _p.r(182);
        var GridPainter = _p.r(180);
        var BorderPainter = _p.r(178);
        var BoxPainter = _p.r(179);
        var PaneLinePainter = _p.r(165);
        return {
            draw: function(canvas, contentCanvas, struct) {
...
_p[188] = {
    value: function(require) {
        var BodyScreen = _p.r(164);
        var TopScreen = _p.r(189);
        var LeftScreen = _p.r(187);
...
_p[192] = {
    value: function(require) {
        ...
        var ScrollEventManager = _p.r(191);
...
_p[196] = {
    value: function(require) {
        var $ = _p.r(2);
        var Util = _p.r(158);
        var NormalWorker = _p.r(194);
        var PaneWorker = _p.r(195);
...
_p[199] = {
    value: function(require) {
        ...
        BTable.module(_p.r(137));
        BTable.mapEvent(_p.r(91));
        BTable.Interpreter = _p.r(118);
        BTable.ExcelAdapter = _p.r(100);
